...
/**
 * Edit the autogenerated openapi document to: 1) Use as schema for the registry endpoint the actual
 * JSON Schema in use. 2) Use as a schema for the JSON Schema API the external definition of the
 * JSON schema spec instead of the jackson JsoNode.
 */
...
public class RegistryOpenApiFilter implements OASFilter {
    ...
    public void filterOpenAPI(OpenAPI openAPI) {
        ...
        if (schemaCache.isResolvable()) {
            ...
            // use
            PathItem pathItem = openAPI.getPaths().getPathItem("/metadata/v1");
    ...
    // maps a single JsonNode property in the JSON schema to the Schema object for the OpenAPI
    // document.
